...
#define STRING_CONFIG_H_AUTHOR "(JM Collongette, Geeetech I3 X)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Geeetech I3 X"
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define BACK_PROBE_BED_POSITION 164
